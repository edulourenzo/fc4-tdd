...
describe("PropertyController E2E", () => {
  ...
  it("deve criar uma propriedade com sucesso", async () => {
    const response = await request(app).post("/properties").send({
      name: "Casa de Campo",
      description: "Linda casa com vista para as montanhas",
      maxGuests: 8,
    ...
    expect(response.body.property.name).toBe("Casa de Campo");
  });
